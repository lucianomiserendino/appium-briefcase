...
public class VoteInformation_StepDefinitions {
	...
	public void for_each_referral_observes_the_filer_s_name_first_initial_of_pr_middle_name_gn_display_party_type_and_date_filed_displays_in_a_light_blue_heading_Use(
		...
		if (dbType.equals("CMKA")) {
			page.getFilersInformation(FILERs_INFO.VOTE_INFO_FILLRES_INFORMATION, DBType.CMKA, cmr_ju_pe_id, cmr_cs_caseid,
					cmr_cyv_code, ccr_id);
			page.getFilersInformation(FILERs_INFO.VOTE_INFO_RELIEF, DBType.CMKA, cmr_ju_pe_id, cmr_cs_caseid, cmr_cyv_code,
					ccr_id);
		} else {
			page.getFilersInformation(FILERs_INFO.VOTE_INFO_FILLRES_INFORMATION, DBType.CM3A, cmr_ju_pe_id, cmr_cs_caseid,
					cmr_cyv_code, ccr_id);
			page.getFilersInformation(FILERs_INFO.VOTE_INFO_RELIEF, DBType.CM3A, cmr_ju_pe_id, cmr_cs_caseid, cmr_cyv_code,
					ccr_id);
		}
	}
	...
	public void user_selects_action_user_verifies_the_name_of_the_action_a_toggle_under_the_Enter_Vote_banner_and_the_label_displays(String action, String enterVote, String label)  {
	...
	public void user_verifies_the_filers_information_the_relief_text_judge_s_current_vote_displays_logged_in_judge_s_initials_using_If_there_is_not_a_current_vote_the_text_displays(String cmr_ju_pe_id, String cmr_cs_caseid, String cmr_cyv_code, String ccr_id, String arg5) {
		page.getFilersInformation(FILERs_INFO.JUDGE_VOTE_FILLRES_INFORMATION, DBType.CMKA, cmr_ju_pe_id, cmr_cs_caseid,
				cmr_cyv_code, ccr_id);
		
		page.getFilersInformation(FILERs_INFO.JUDGE_VOTE_RELIEF, DBType.CMKA, cmr_ju_pe_id, cmr_cs_caseid,
				cmr_cyv_code, ccr_id);
