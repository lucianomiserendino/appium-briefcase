...
public class NoticesOfDocketActivity_StepDefinitions {
	...
	public void user_selects_case_that_is_in_Briefcase_for_a_judge_Verifies_the_docket_entry_page_in_Briefcase_displays_the_docket_entry_Open_a_Docket_Entry_in_Briefcase_from_the_NDA_link(
		...
		page.openDktEntryInBriefcase(caseNum, dbType);
	}

	@Then("^Verify the document opens in briefcase by using the same \"([^\"]*)\" and \"([^\"]*)\" \\(Open a document in Briefcase from the NDA link\\)\\.$")
	public void verify_the_document_opens_in_briefcase_by_using_the_same_and_Open_a_document_in_Briefcase_from_the_NDA_link(
			String caseNum, String dbType) {
