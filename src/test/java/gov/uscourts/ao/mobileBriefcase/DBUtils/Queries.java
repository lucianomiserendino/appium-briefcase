...
public class Queries {
	...
	public static final String DB_LIST_OF_CATEGORIES="SELECT DISTINCT (CYV_CATEGORY) FROM CHM_MOBILE_REFERRAL, CHM_REFTYPE_VAL WHERE  CMR_JU_PE_ID = '32' AND CMR_DATE_END IS NULL AND CMR_CYV_CODE = CYV_CODE AND CYV_IS_BRIEFCASE = 'y'";
}
