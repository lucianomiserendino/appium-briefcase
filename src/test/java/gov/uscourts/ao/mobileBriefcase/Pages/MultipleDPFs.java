...
public class MultipleDPFs extends AppiumPageFactory {
	...
	public void createAnAssignment(DBType dbType, String dpfName, String elId, String cha_ju_pe_id, String cmr_cyv_code,
		 ...
		 */
		// tapOnDropDown(3, "Staff Member", "Please Select");
		...
		// tapOnDropDown(5, "Assignment", "Please Select");
		// getAssignmentType(dbType, dpfName, elId, cha_ju_pe_id, cmr_cs_caseid,
		// cmr_cyv_code, staffFName, staffLName);
		//
		// /** STEP 3 --Select an Assigned Date */
		// tapOnDropDown(7, "Assigned", "Select Date");
		// // // selectADate(2);
		...
		// tapOnDropDown(9, "Assignment Due", "Select Date");
		// // selectADate(1);
		// performPageLoad(driver);
		 ...
		 */
		// assignmentNameAndType = getCreatedAssignmentNameAndAssignmentType(staffFName
		// + " " + staffLName, assignment);
