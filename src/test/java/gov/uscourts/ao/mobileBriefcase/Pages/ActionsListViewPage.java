...
import static gov.uscourts.ao.mobileBriefcase.common.Utility.findElementAndScroll;
...
public class ActionsListViewPage extends AppiumPageFactory {
	...
	public static void scrollToAction(String actionName) {
		assertTrue(findElementAndScroll(
				"//XCUIElementTypeOther[@name='DocumentList']//XCUIElementTypeStaticText[contains(@name, '" + actionName
						+ "')]"));
	}
