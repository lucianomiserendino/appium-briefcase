...
public class BackgroundColor extends AppiumPageFactory {
	 ...
	 * @throws IOException
	 */
	public String getColorNameFromHex(WebElement element) throws IOException {
	...
	public String getBackgroundColor(WebElement el) throws IOException {

		return getColorNameFromHex(el);
