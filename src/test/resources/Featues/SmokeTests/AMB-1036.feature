...
4.  Each judge's vote and the date they voted
       ...
       Given User selects Judge Colloton  >> Petitions for Rehearing >> "15-3314"
       When User observes the "Vote Information" panel displays.   This should only display if the referral requires voting
