...
@AMB-1033 
   Scenario Outline: 
	...
	Then User verifies text displays under the description 
		...
		Examples: 
		|environment   |userName          |password  |server                                   |category       | case |dbType| 
...
Scenario Outline: 
	...
	Examples: 
		...
		|Integration   |chambers courtney |Test2021! |Appellate DC Development - CMKA           |Motions/Petitions |15-3314 |
