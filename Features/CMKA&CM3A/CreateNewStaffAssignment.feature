...
Scenario Outline: 
	...
	Then User clicks on "Apply" and then "Submit" button and verifies that beck end "<dbType>" is updated correctly using "<cha_ju_pe_id>"
	...
	Examples: 
		...
		#|Integration   |chambers courtney |Test2021! |Appellate DC Development - CMKA           |Petitions for Rehearing |CMKA   |15-3314  |3116        |32          |82226        |CMKA  |
		#|Testing       |judgewilliams   |Testpass1! |Appellate DC Installation Testing - CM3A   |Rehearing Petition      |CM3A   |11-1012  |4286        |2189563     |67317        |CM3A  |
